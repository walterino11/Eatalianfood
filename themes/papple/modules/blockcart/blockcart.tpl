	...
	{/if}
		...
		<p id="cart-buttons">
			{if $order_process == 'order'}
				<a href="{$link->getPageLink("$order_process.php", true)}" class="btn_cart" title="{l s='Cart' mod='blockcart'}">
					<span><span>{l s='Cart' mod='blockcart'}</span></span>
				</a>
			{/if}
			<a href="{$link->getPageLink("$order_process.php", true)}{if $order_process == 'order'}?step=1{/if}" id="button_order_cart" class="btn_cart" title="{l s='Check out' mod='blockcart'}">
				<span><span>{l s='Check out' mod='blockcart'}</span></span>
			</a>
		</p>
	</div>
	</div>
