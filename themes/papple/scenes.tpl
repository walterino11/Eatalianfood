...
<div id="scenes">
	...
	<div class="thumbs_banner">
		<span class="space-keeper">
			<a class="prev" href="#" onclick="{ldelim}next_scene_is_at_right = false; $(this).parent().next().trigger('stop').trigger('prev'); return false;{rdelim}">&nbsp;</a>
		</span>
		<div id="scenes_list">
		...
		<span class="space-keeper">
			<a class="next" href="#" onclick="{ldelim}next_scene_is_at_right = true; $(this).parent().prev().trigger('stop').trigger('next'); return false;{rdelim}">&nbsp;</a>
		</span>
	</div>
	{/if}
</div>
