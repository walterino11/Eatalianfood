<?php /* Smarty version Smarty-3.0.7, created on 2012-02-07 16:33:20
         compiled from "/web/htdocs/www.eatalianfood.com/home/themes/papple/./product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14860607164f3198a00de252-27840995%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd793fa99d577c5c2c6f4805e9f4e8079e56c1e3' => 
    array (
      0 => '/web/htdocs/www.eatalianfood.com/home/themes/papple/./product-list.tpl',
      1 => 1328574506,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14860607164f3198a00de252-27840995',
  'function' => 
  array (
  ),
...
"><?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['name'],35,'...'),'htmlall','UTF-8');?>
				 ...
				 <p class="product_desc"> <?php echo $_smarty_tpl->tpl_vars['product']->value['description_short'];?>
 </p>
			</div>																				 
...
<?php }?></span><?php }?>
				...
				<?php if (($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']==0||(isset($_smarty_tpl->getVariable('add_prod_display',null,true,false)->value)&&($_smarty_tpl->getVariable('add_prod_display')->value==1)))&&$_smarty_tpl->tpl_vars['product']->value['available_for_order']&&!isset($_smarty_tpl->getVariable('restricted_country_mode',null,true,false)->value)&&$_smarty_tpl->tpl_vars['product']->value['minimal_quantity']<=1&&$_smarty_tpl->tpl_vars['product']->value['customizable']!=2&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?>
					<?php if (($_smarty_tpl->tpl_vars['product']->value['allow_oosp']||$_smarty_tpl->tpl_vars['product']->value['quantity']>0)){?>
						<a class="btn_cart ajax_add_to_cart_button" rel="ajax_id_product_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
"><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
					...
					<?php }else{ ?>
							<span class="btn_cart"><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
</span>
					<?php }?>
				<?php }?>
				<a class="btn_more" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['link'],'htmlall','UTF-8');?>
