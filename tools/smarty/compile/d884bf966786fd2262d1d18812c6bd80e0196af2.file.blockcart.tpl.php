<?php /* Smarty version Smarty-3.0.7, created on 2012-02-04 13:24:18
         compiled from "/web/htdocs/www.eatalianfood.com/home/themes/papple_w1.3.2/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6098083674f2d77d210e800-67288664%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd884bf966786fd2262d1d18812c6bd80e0196af2' => 
    array (
      0 => '/web/htdocs/www.eatalianfood.com/home/themes/papple_w1.3.2/modules/blockcart/blockcart.tpl',
      1 => 1328378969,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6098083674f2d77d210e800-67288664',
  'function' => 
  array (
  ),
...
<?php }?></span>
		...
		<?php }?>
		<p id="cart-buttons">
			<?php if ($_smarty_tpl->getVariable('order_process')->value=='order'){?>
				<a href="<?php echo $_smarty_tpl->getVariable('link')->value->getPageLink(($_smarty_tpl->getVariable('order_process')->value).".php",true);?>
" class="btn_cart" title="<?php echo smartyTranslate(array('s'=>'Cart','mod'=>'blockcart'),$_smarty_tpl);?>
">
					<span><span><?php echo smartyTranslate(array('s'=>'Cart','mod'=>'blockcart'),$_smarty_tpl);?>
</span></span>
				</a>
			<?php }?>
			<a href="<?php echo $_smarty_tpl->getVariable('link')->value->getPageLink(($_smarty_tpl->getVariable('order_process')->value).".php",true);?>
<?php if ($_smarty_tpl->getVariable('order_process')->value=='order'){?>?step=1<?php }?>" id="button_order_cart" class="btn_cart" title="<?php echo smartyTranslate(array('s'=>'Check out','mod'=>'blockcart'),$_smarty_tpl);?>
">
