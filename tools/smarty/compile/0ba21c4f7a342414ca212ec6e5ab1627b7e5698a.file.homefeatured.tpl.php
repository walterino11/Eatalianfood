<?php /* Smarty version Smarty-3.0.7, created on 2012-02-04 13:24:17
         compiled from "/web/htdocs/www.eatalianfood.com/home/themes/papple_w1.3.2/modules/homefeatured/homefeatured.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19240575774f2d77d1aceca0-52954936%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ba21c4f7a342414ca212ec6e5ab1627b7e5698a' => 
    array (
      0 => '/web/htdocs/www.eatalianfood.com/home/themes/papple_w1.3.2/modules/homefeatured/homefeatured.tpl',
      1 => 1328378988,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19240575774f2d77d1aceca0-52954936',
  'function' => 
  array (
  ),
...
<?php }?></span></p><?php }else{ ?><div style="height:21px;"></div><?php }?>
						...
						<?php if (($_smarty_tpl->tpl_vars['product']->value['id_product_attribute']==0||(isset($_smarty_tpl->getVariable('add_prod_display',null,true,false)->value)&&($_smarty_tpl->getVariable('add_prod_display')->value==1)))&&$_smarty_tpl->tpl_vars['product']->value['available_for_order']&&!isset($_smarty_tpl->getVariable('restricted_country_mode',null,true,false)->value)&&$_smarty_tpl->tpl_vars['product']->value['minimal_quantity']==1&&$_smarty_tpl->tpl_vars['product']->value['customizable']!=2&&!$_smarty_tpl->getVariable('PS_CATALOG_MODE')->value){?>
							...
							<a class="btn_cart ajax_add_to_cart_button" rel="ajax_id_product_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
...
"><?php echo smartyTranslate(array('s'=>'Add to cart','mod'=>'homefeatured'),$_smarty_tpl);?>
						...
						<?php }?>
						<a class="btn_more" href="<?php echo $_smarty_tpl->tpl_vars['product']->value['link'];?>
