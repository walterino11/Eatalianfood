<?php /* Smarty version Smarty-3.0.7, created on 2012-02-07 16:33:19
         compiled from "/web/htdocs/www.eatalianfood.com/home/themes/papple/./scenes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:658402414f31989fa28f25-91919891%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '98b5767a271804b97e72c70ca44c46445a385bae' => 
    array (
      0 => '/web/htdocs/www.eatalianfood.com/home/themes/papple/./scenes.tpl',
      1 => 1328408778,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '658402414f31989fa28f25-91919891',
  'function' => 
  array (
  ),
...
" />
	...
	<div class="thumbs_banner">
		<span class="space-keeper">
			<a class="prev" href="#" onclick="{next_scene_is_at_right = false; $(this).parent().next().trigger('stop').trigger('prev'); return false;}">&nbsp;</a>
		</span>
		<div id="scenes_list">
...
" />
		...
		<span class="space-keeper">
			<a class="next" href="#" onclick="{next_scene_is_at_right = true; $(this).parent().prev().trigger('stop').trigger('next'); return false;}">&nbsp;</a>
		</span>
	</div>
	<?php }?>
</div>
